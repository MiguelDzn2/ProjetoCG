...
class Example(Base):
    ...
    def initialize(self):
        ...
        # Add a second blue directional light pointing from left to right
        self.blue_directional_light = DirectionalLight(color=[0, 0, 0.8], direction=[1, 0, 0])
        self.scene.add(self.blue_directional_light)
        ...
        # Create helper for the blue directional light
        blue_directional_light_helper = DirectionalLightHelper(self.blue_directional_light)
        # Position the blue light at the bottom of the window
        self.blue_directional_light.set_position([0, -2, 0])
        self.blue_directional_light.add(blue_directional_light_helper)
    ...
    def update(self):
        ...
        # Update the blue directional light with the same oscillatory movement
        self.blue_directional_light.set_direction([1, -math.sin(0.5 * self.time), 0])
